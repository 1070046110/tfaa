...
# casmeⅡ-3c
        ...
        file.write("casmeⅡ-3c   acc:"+str(np.mean(accs)) + "   "+"f1:"+str(np.mean(f1s))+ "   "+"uar:"+str(np.mean(uars))+'\n')
        file.close()
...
# samm-5c
    ...
    for j in range(10):
        ...
        print("acc:" + str(np.mean(accs)) + "   " + "f1:" + str(np.mean(f1s)) + "   " + "uar:" + str(np.mean(uars)))
        file = open("best.txt", 'a')
        file.write("samm-3c   acc:" + str(np.mean(accs)) + "   " + "f1:" + str(np.mean(f1s)) + "   " + "uar:" + str(
            np.mean(uars)) + '\n')
        file.close()
    ...
    for j in range(10):
            ...
            print("acc:" + str(np.mean(accs)) + "   " + "f1:" + str(np.mean(f1s)) + "   " + "uar:" + str(np.mean(uars)))
            file = open("best.txt", 'a')
            file.write("smic-3c   acc:" + str(np.mean(accs)) + "   " + "f1:" + str(np.mean(f1s)) + "   " + "uar:" + str(
                np.mean(uars)) + '\n')
            file.close()
