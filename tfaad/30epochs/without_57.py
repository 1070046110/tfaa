...
# full-3c
    for j in range(c):
        ...
        file = open("results.txt", 'a')
        file.write(
            "focal-without weighted    full-3c   acc:" + str(acc) + "   " + "f1:" + str(f1) + "   " + "uf1:" + str(uf1) + "   " + "uar:" + str(
                uar) + '\n')
        alist = []
        for h in range(kl_3.shape[0]):
            for v in range(kl_3.shape[1]):
...
# full-3c
    for j in range(c):
        ...
        file = open("results.txt", 'a')
        file.write(
            "without-attention  full-3c   acc:" + str(acc) + "   " + "f1:" + str(f1) + "   " + "uf1:" + str(uf1) + "   " + "uar:" + str(
                uar) + '\n')
        alist = []
        for h in range(kl_3.shape[0]):
            for v in range(kl_3.shape[1]):
